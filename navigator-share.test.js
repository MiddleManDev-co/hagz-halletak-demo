...
for(const id of ['full','customer','venue','admin','investor','business'])assert(js.includes(`'${id}'`),`share tour missing ${id}`);
...
assert(js.includes('biStopTour'),'free explore/reset must stop business tour');
